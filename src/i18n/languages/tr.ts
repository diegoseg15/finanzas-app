export const tr = {
  ...
  accounts: {
    title: "Hesaplar",
    description:
      "Banka, nakit, kripto para, kart ve borç hesaplarını kaydedin.",
    ...
    emptyDescription:
      "Gelir, gider ve transferleri kaydetmeye başlamak için ilk hesabınızı oluşturun.",
    ...
    limitDescription:
      "Ücretsiz plan en fazla 3 hesaba izin verir. Sınırsız hesap oluşturmak için Plus'ı etkinleştirin.",

    deleteTitle: "Hesabı sil",
    deleteDescription:
      "Bu hesap aktif listeden gizlenecek. Geçmiş hareketleri korunacaktır.",
    ...
    form: {
      ...
      balanceEditInfo:
        "Bakiye, hesabı düzenleyerek değil hareket kaydederek güncellenir.",
      ...
      currencyEditInfo:
        "Hareket geçmişini bozmamak için düzenleme sırasında ana para birimi değiştirilemez.",

      includeInTotal: "Tahmini toplama ekle",
      includeInTotalDescription:
        "Bu hesabın toplam bakiyenize eklenmesini istiyorsanız bunu etkinleştirin.",

      initialBalanceRequired:
        "Başlangıç bakiyesi zorunludur. Bakiyesi yoksa 0 kullanın.",
    ...
    types: {
      ...
      crypto_exchange: {
        ...
        description:
          "Binance gibi uygulamalardaki veya diğer kripto platformlarındaki hesap.",
      },
      crypto_wallet: {
        label: "Kripto cüzdanı",
        description:
          "MetaMask gibi kripto saklamak için kullanılan cüzdan veya uygulama.",
      },
      credit_card: {
        label: "Kredi kartı",
  ...
  movements: {
    ...
    emptyDescription:
      "Finans geçmişinizi oluşturmaya başlamak için ilk gelirinizi, giderinizi veya transferinizi kaydedin.",
    ...
    firstCreateAccountDescription:
      "Gelir veya gider kaydetmek için en az bir aktif hesaba ihtiyacınız var.",

    limitTitle: "Ücretsiz hareket limitine ulaştınız",
    limitDescription:
      "Ücretsiz plan ayda en fazla 30 harekete izin verir. Sınırsız hareket kaydetmek için Plus'ı etkinleştirin.",

    deleteMovementTitle: "Hareketi sil",
    deleteMovementDescription:
      "Bu işlem, bu hareketin etkilediği bakiyeyi geri alacaktır.",

    deleteTransferTitle: "Transferi sil",
    deleteTransferDescription:
      "Bu işlem, bu transferin etkilediği bakiyeleri geri alacaktır.",
    ...
    negativeBalanceWarning: "Bu gider hesabı negatif bakiyeye düşürecek.",
    ...
    transferCard: {
      ...
      fee: "Ücret",
      exchangeRate:
        "Kullanılan kur: 1 {{fromCurrency}} = {{exchangeRate}} {{toCurrency}}",
    },
    ...
    transferForm: {
      ...
      fromCurrency: "Gönderilen para birimi",
      toCurrency: "Alınan para birimi",
      feeAmount: "Maliyet veya ücret",
      feeCurrency: "Ücret para birimi",
      ...
      description:
        "Hesaplar arasında para taşıyın ve ücretleri veya döviz dönüşümünü kaydedin.",
      ...
      multiCurrencyBlockedByPlan:
        "Ücretsiz plan yalnızca aynı para birimindeki hesaplar arasında transfere izin verir.",

      negativeBalanceWarning:
        "Bu transfer kaynak hesabı negatif bakiyeye düşürecek.",
      ...
      multiCurrencyPlusTitle:
        "Para birimleri arası transferler Plus'ta kullanılabilir",
      multiCurrencyPlusDescription:
        "Ücretsiz planda aynı para birimindeki hesaplar arasında transfer yapabilirsiniz. Döviz dönüşümlü transferler için Plus'ı etkinleştirin.",
    },
  },
  ...
  statistics: {
    title: "İstatistikler",
    description:
      "Gelirlerinizi, giderlerinizi, transferlerinizi ve kategorilerinizi inceleyin.",
    ...
    filtersDescription:
      "Dönemi, hesabı, kategoriyi ve para birimini ayarlayın.",
    ...
    charts: {
      ...
      incomeVsExpenseDescription:
        "Giren ve çıkan paranın aylık karşılaştırması.",
    ...
    empty: {
      ...
      noIncomeExpenseChart:
        "Grafik oluşturmak için gelir veya gider verisi yok.",
      noBalanceTrend: "Eğilim göstermek için henüz yeterli bakiye verisi yok.",
      noExpenseCategoriesChart:
        "Grafik oluşturmak için kategoriye göre gider yok.",
      noFilterDataTitle: "Bu filtreler için veri yok",
      noFilterDataDescription:
        "İstatistikleri görmek için dönemi değiştirin veya hareket kaydedin.",
  ...
  reports: {
    export: {
      ...
      description:
        "Hesaplarınızı, gelirlerinizi, giderlerinizi ve transferlerinizi bir dosya olarak indirin.",
    },

    filters: {
      title: "Filtreler",
      description: "Dönemi, hesabı, kategoriyi ve para birimini ayarlayın.",
      panelDescription:
        "Analiz etmek istediğiniz dönemi ve verileri ayarlayın.",
  ...
  settings: {
    title: "Ayarlar",
    description:
      "Deneyiminizi, verilerinizi, gizliliğinizi ve planınızı yapılandırın.",
    ...
    privacy: "Gizlilik",
    privacyDescription:
      "Verilerinizin Orvian içinde nasıl işlendiğini kontrol edin.",
    privacyPolicy: "Gizlilik politikası",
    openPrivacyPolicy: "Gizlilik politikasını gör",

    exportData: "Verileri dışa aktar",
    exportDescription:
      "Hesaplarınız, hareketleriniz ve transferlerinizle dosyalar oluşturun.",
    exporting: "Dışa aktarılıyor...",
    ...
    localDataDescription:
      "Verileriniz bu cihazda kaydedilir. Hesap senkronizasyonu daha sonra etkinleştirilebilir.",
    viewOnboardingAgain: "Tanıtımı tekrar gör",
    resetData: "Yerel verileri sil",

    about: "Orvian hakkında",
    aboutDescription:
      "Orvian; hesaplarınızı, giderlerinizi, bütçelerinizi ve kişisel özetlerinizi düzenlemenize yardımcı olur.",
    app: "Uygulama",
    version: "Sürüm",
    ...
    privacyLinkErrorDescription:
      "Cihazınız şu anda gizlilik politikasını açamıyor.",

    resetDataTitle: "Yerel verileri sil",
    resetDataDescription:
      "Bu işlem, bu cihazda kayıtlı hesapları, hareketleri, transferleri, hatırlatmaları ve ayarları silecektir.",
  ...
  onboarding: {
    welcome: {
      ...
      description:
        "Hesapları, gelirleri, giderleri, transferleri, hatırlatmaları ve finansal planları yerel ve gizli bir uygulamadan kaydedin.",
    ...
    setup: {
      ...
      description:
        "Bu yanıtlar, hesap oluşturmanızı zorunlu kılmadan uygulamayı kişiselleştirir.",
    },
    ...
    stepOne: {
      ...
      calculateTotalNetWorthDescription:
        "Bankaları, nakdi, kriptoyu ve diğer hesapları tek bir genel bakiyede toplayın.",
      userType: "Kullanıcı türü",

      personal: "Kişisel",
      personalDescription: "Kişisel finansımı yönetmek istiyorum.",

      business: "İşletme",
      businessDescription:
        "Bir işletmenin gelir ve giderlerini kontrol etmek istiyorum.",
    },

    stepTwo: {
      cryptoUsage: "Kripto para kullanımı",
      noCrypto: "Kripto kullanmıyorum",
      noCryptoDescription:
        "Binance veya MetaMask gibi hesaplara ihtiyacım yok.",
      useCrypto: "Evet, kripto kullanıyorum",
      useCryptoDescription:
        "Binance, MetaMask veya diğer kripto hesaplarını kaydetmek istiyorum.",

      multiCurrencyUsage: "Birden fazla para birimi kullanımı",
      singleCurrency: "Yalnızca tek para birimi",
      singleCurrencyDescription: "Genellikle tek bir para birimi kullanıyorum.",
      multipleCurrencies: "Birden fazla para birimi",
      multipleCurrenciesDescription:
        "Farklı para birimlerinde hesaplar kullanıyorum.",
    },

    stepThree: {
      mainGoal: "Ana hedef",

      controlExpenses: "Giderleri kontrol etmek",
      controlExpensesDescription: "Paramın nereye gittiğini bilmek istiyorum.",

      saveMoney: "Daha fazla biriktirmek",
      saveMoneyDescription:
        "Hedefler ve yedek para için para ayırmak istiyorum.",

      organizeAccounts: "Hesapları düzenlemek",
      organizeAccountsDescription:
        "Bankaları, nakdi, kartları ve borçları düzenli görmek istiyorum.",

      activateFinancialReminders: "Finansal hatırlatmaları etkinleştir",
      activateFinancialRemindersDescription:
        "Bu, ödemeleri, tahsilatları, alışverişleri veya birikimleri hatırlamanıza yardımcı olur.",
    ...
    options: {
      userProfile: {
        ...
        investor: {
          label: "Yatırımcı",
          description:
            "Varlıkları, kriptoyu veya yatırımları takip etmek istiyorum.",
        },
        student: {
          label: "Öğrenci",
      ...
      cryptoUsage: {
        ...
        basic: {
          ...
          description:
            "Borsaları, cüzdanları veya dijital varlıkları kaydetmek istiyorum.",
        },
        advanced: {
          label: "Kripto kullanıyorum ama önceliğim değil",
          description:
            "Kriptoyu kaydetmek istiyorum ama benim için en önemli şey bu değil.",
        },
      },
      ...
      multiCurrencyUsage: {
        ...
        frequent: {
          label: "Sık sık",
          description:
            "Birden fazla para biriminde hesapları sık kullanıyorum.",
        },
      },
      ...
      financialGoal: {
        ...
        pay_debts: {
          ...
          description:
            "Borçlarımı ve bekleyen ödemelerimi düzenlemek istiyorum.",
        },
        track_income: {
          label: "Gelirimi takip etmek",
          description:
            "Gelir kaynaklarımı net bir şekilde kontrol etmek istiyorum.",
        },
        understand_investments: {
          label: "Yatırımlarımı anlamak",
          description:
            "Varlıklarımı, kriptoyu veya yatırımlarımı daha iyi takip etmek istiyorum.",
        },
        avoid_small_expenses: {
          label: "Küçük günlük giderlerden kaçınmak",
          description:
            "Küçük günlük harcamaları belirlemek ve kontrol etmek istiyorum.",
        },
      },
    },
    ...
    plans: {
      ...
      description:
        "Uygulamayı ücretsiz kullanabilir ve gelişmiş özellikleri daha sonra etkinleştirebilirsiniz.",
  ...
  budgets: {
    ...
    allCategoriesAlreadyBudgeted:
      "Mevcut tüm kategoriler için zaten limit eklediniz.",
    budgetedCategories: "Limitli kategoriler",
    budgetOf: "{{period}} bütçesi",
    currentSpendingVsBudget:
      "Mevcut harcama, aylık limitinizle karşılaştırıldı.",
    spent: "Harcanan",
    limit: "Limit",
    ...
    modalDescription:
      "Aylık giderlerinizi kontrol etmek için limitler belirleyin.",
    ...
    categoryBudgetDescription:
      "Yalnızca kontrol etmek istediğiniz gider kategorilerine limit ekleyin.",
    ...
    emptyDescription:
      "Giderlerinizi daha iyi kontrol etmek için aylık bütçe oluşturun.",
  ...
  reminders: {
    ...
    emptyDescription:
      "Ödemeler, tahsilatlar, abonelikler, alışverişler veya birikimler için hatırlatmalar oluşturun.",
    ...
    types: {
      ...
      subscription: {
        label: "Abonelik",
        description:
          "Netflix, Spotify, yazılım veya diğer tekrarlayan ödemeler.",
      },
      saving: {
        label: "Birikim",
    ...
    deleteTitle: "Hatırlatmayı sil",
    deleteDescription:
      "Bu hatırlatma artık yaklaşan uyarılarınızda görünmeyecek.",
  },
  ...
  plans: {
    ...
    demoDescription:
      "Ücretsiz başlayın ve ihtiyaç duyduğunuzda gelişmiş özellikleri etkinleştirin.",
    monthlyPeriod: "aylık",
