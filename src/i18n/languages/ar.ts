export const ar = {
  ...
  onboarding: {
    ...
    v2: {
      control: {
        title: "تحكم في أموالك بدون تعقيد",
        description: "نظّم الحسابات والأرصدة والحركات من مكان واحد."
      },
      movements: {
      ...
      start: "ابدأ الآن",
      welcome: {
        title: "مرحبًا بك في Orvian",
        description: "طريقة أوضح وأسهل لإدارة أموالك وحساباتك والتزاماتك القادمة."
      },
      accounts: {
        title: "حساباتك أكثر تنظيمًا",
        description: "أنشئ حسابات وتابع الأرصدة وخصص البطاقات لرؤية أموالك بوضوح."
      },
      analytics: {
        title: "افهم أموالك بنظرة واحدة",
        description: "شاهد الاتجاهات والمصروفات والدخل برسوم بسيطة لاتخاذ قرارات أفضل."
      },
      plans: {
  ...
  guides: {
    ...
    homeTour: {
      totalBalance: "هنا ترى الرصيد الإجمالي التقديري لحساباتك.",
      accounts: "هذه حساباتك الرئيسية. اضغط على أحدها لرؤية التفاصيل.",
      monthlySummary: "هنا يمكنك رؤية ملخص الدخل والمصروفات والرصيد لهذا الشهر.",
      recentActivity: "تظهر هنا أحدث الحركات والتحويلات الخاصة بك."
    },
    statisticsTour: {
      filters: "استخدم هذا الزر لتصفية الإحصاءات حسب التاريخ أو الحساب أو الفئة أو العملة أو نوع الحركة.",
      summary: "هنا ترى ملخص الفترة: الدخل والمصروفات والتحويلات والرسوم والرصيد.",
      incomeVsExpense: "يقارن هذا الرسم بين الدخل والمصروفات شهريًا لمعرفة ما إذا كنت تنفق أكثر مما يدخل.",
      balanceEvolution: "هنا ترى كيف يتغير رصيدك مع الوقت وما إذا كان اتجاهك المالي يتحسن أو يسوء.",
      topCategories: "يوضح هذا الرسم أكبر فئات المصروفات لتعرف أين يذهب مالك.",
      budgetUsed: "إذا كان لديك ميزانية نشطة، فهنا ترى مقدار ما استخدمته وما إذا كنت قريبًا من الحد.",
