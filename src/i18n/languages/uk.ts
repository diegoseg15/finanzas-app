export const uk = {
  ...
  onboarding: {
    ...
    v2: {
      ...
      security: {
        title: "Ваші дані захищені",
        description: "Orvian зберігає вашу фінансову інформацію в безпечному зашифрованому сховищі на вашому пристрої, щоб ви зберігали контроль над своїми даними."
      }
    }
  },
  budgets: {
