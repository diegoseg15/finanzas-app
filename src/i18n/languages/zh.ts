export const zh = {
  ...
  accounts: {
    ...
    limitDescription:
      "免费计划最多允许创建 3 个账户。激活 Plus 即可创建无限账户。",
  ...
  movements: {
    ...
    limitDescription:
      "免费计划每月最多允许记录 30 笔交易。激活 Plus 即可记录无限交易。",
    ...
    negativeBalanceWarning: "这笔支出会使账户余额变为负数。",
    ...
    transferCard: {
      ...
      fee: "手续费",
      exchangeRate:
        "使用汇率：1 {{fromCurrency}} = {{exchangeRate}} {{toCurrency}}",
    },
    ...
    transferForm: {
      ...
      negativeBalanceWarning: "这笔转账会使来源账户余额变为负数。",
      ...
      multiCurrencyPlusDescription:
        "在免费计划中，你可以在相同货币的账户之间转账。如需进行带货币兑换的转账，请激活 Plus。",
    },
  },
  ...
  onboarding: {
    welcome: {
      title: "在一个地方管理你的钱",
      description:
        "通过一个本地且私密的应用记录账户、收入、支出、转账、提醒和财务计划。",
    ...
    stepOne: {
      ...
      calculateTotalNetWorthDescription:
        "将银行、现金、加密货币和其他账户合并为一个总余额。",
      userType: "用户类型",

      personal: "个人",
      personalDescription: "我想管理个人财务。",

      business: "业务",
      businessDescription: "我想控制业务的收入和支出。",
    },

    stepTwo: {
      cryptoUsage: "加密货币使用情况",
      noCrypto: "我不使用加密货币",
      noCryptoDescription: "我不需要 Binance 或 MetaMask 之类的账户。",
      useCrypto: "是的，我使用加密货币",
      useCryptoDescription: "我想记录 Binance、MetaMask 或其他加密货币账户。",

      multiCurrencyUsage: "多货币使用情况",
      singleCurrency: "只使用一种货币",
      singleCurrencyDescription: "我主要使用一种货币。",
      multipleCurrencies: "使用多种货币",
      multipleCurrenciesDescription: "我使用不同货币的账户。",
    },

    stepThree: {
      mainGoal: "主要目标",

      controlExpenses: "控制支出",
      controlExpensesDescription: "我想知道钱花到哪里去了。",

      saveMoney: "存更多钱",
      saveMoneyDescription: "我想为目标和备用金存钱。",

      organizeAccounts: "整理账户",
      organizeAccountsDescription: "我想有条理地查看银行、现金、卡片和债务。",
  ...
  reminders: {
    ...
    deleteTitle: "删除提醒",
    deleteDescription: "此提醒将不再出现在你的即将提醒中。",
  },
