export const fr = {
  ...
  accounts: {
    title: "Comptes",
    description:
      "Enregistrez vos banques, espèces, cryptomonnaies, cartes et prêts.",
    ...
    emptyDescription:
      "Créez votre premier compte pour commencer à enregistrer vos revenus, dépenses et virements.",
    ...
    limitDescription:
      "Le forfait gratuit permet jusqu’à 3 comptes. Activez Plus pour créer des comptes illimités.",

    deleteTitle: "Supprimer le compte",
    deleteDescription:
      "Ce compte sera masqué de la liste active. Ses opérations historiques seront conservées.",
    ...
    form: {
      ...
      editTitle: "Modifier le compte",
      editDescription:
        "Mettez à jour les informations principales de ce compte.",
      createDescription:
        "Configurez les informations principales de ce compte.",
      ...
      balanceEditInfo:
        "Le solde est mis à jour en enregistrant des opérations, pas en modifiant le compte.",
      ...
      currencyEditInfo:
        "La devise principale ne peut pas être modifiée lors de l’édition afin d’éviter d’altérer l’historique des opérations.",

      includeInTotal: "Ajouter au total estimé",
      includeInTotalDescription:
        "Activez cette option si vous voulez que ce compte soit ajouté à votre solde total.",

      initialBalanceRequired:
        "Le solde initial est obligatoire. Utilisez 0 s’il n’y a pas de solde.",
    ...
    types: {
      ...
      crypto_exchange: {
        ...
        description:
          "Compte dans des applications comme Binance ou d’autres plateformes crypto.",
      },
      crypto_wallet: {
        label: "Portefeuille crypto",
        description:
          "Portefeuille comme MetaMask ou autres applications pour stocker des cryptomonnaies.",
      },
      credit_card: {
  ...
  movements: {
    title: "Opérations",
    description:
      "Enregistrez vos revenus, dépenses et virements entre vos comptes.",
    ...
    emptyDescription:
      "Enregistrez votre premier revenu, dépense ou virement pour commencer à construire votre historique financier.",
    ...
    freePlanRemaining:
      "Forfait gratuit : {{count}} opérations disponibles ce mois-ci.",
    ...
    firstCreateAccountDescription:
      "Vous avez besoin d’au moins un compte actif pour enregistrer des revenus ou des dépenses.",

    limitTitle: "Vous avez atteint la limite d’opérations gratuites",
    limitDescription:
      "Le forfait gratuit permet jusqu’à 30 opérations par mois. Activez Plus pour enregistrer des opérations illimitées.",

    deleteMovementTitle: "Supprimer l’opération",
    deleteMovementDescription:
      "Cette action annulera l’impact de cette opération sur le solde.",

    deleteTransferTitle: "Supprimer le virement",
    deleteTransferDescription:
      "Cette action annulera l’impact de ce virement sur les soldes.",
    ...
    negativeBalanceWarning:
      "Cette dépense laissera le compte avec un solde négatif.",
    ...
    form: {
      ...
      allTagsSelected:
        "Vous avez déjà sélectionné toutes les étiquettes disponibles.",
    ...
    transferCard: {
      ...
      fee: "Frais",
      exchangeRate:
        "Taux utilisé : 1 {{fromCurrency}} = {{exchangeRate}} {{toCurrency}}",
    },
    ...
    transferForm: {
      ...
      fromCurrency: "Devise envoyée",
      toCurrency: "Devise reçue",
      feeAmount: "Coût ou frais",
      ...
      description:
        "Déplacez de l’argent entre vos comptes et enregistrez les frais ou le change de devise.",
      ...
      multiCurrencyBlockedByPlan:
        "Le forfait gratuit permet uniquement les virements entre comptes avec la même devise.",

      negativeBalanceWarning:
        "Ce virement laissera le compte source avec un solde négatif.",
      ...
      multiCurrencyPlusTitle:
        "Les virements entre devises sont disponibles avec Plus",
      multiCurrencyPlusDescription:
        "Dans le forfait gratuit, vous pouvez transférer entre comptes avec la même devise. Pour les virements avec change de devise, activez Plus.",
    },
  },
  ...
  statistics: {
    ...
    filtersDescription:
      "Ajustez la période, le compte, la catégorie et la devise.",
    ...
    charts: {
      ...
      incomeVsExpenseDescription:
        "Comparaison mensuelle de l’argent entrant et sortant.",
      ...
      topExpenseCategoriesDescription:
        "Catégories avec la plus grande sortie d’argent.",
    ...
    empty: {
      ...
      noExpenses:
        "Aucune dépense n’a encore été enregistrée sur cette période.",
      noIncome: "Aucun revenu n’a encore été enregistré sur cette période.",
      noIncomeExpenseChart:
        "Aucune donnée de revenus ou de dépenses à afficher dans un graphique.",
      noBalanceTrend:
        "Il n’y a pas encore assez de données de solde pour afficher une tendance.",
      noExpenseCategoriesChart:
        "Aucune dépense par catégorie à afficher dans un graphique.",
      noFilterDataTitle: "Aucune donnée pour ces filtres",
      noFilterDataDescription:
        "Changez la période ou enregistrez des opérations pour voir les statistiques.",
  ...
  reports: {
    export: {
      ...
      description:
        "Téléchargez vos comptes, revenus, dépenses et virements dans un fichier.",
    },

    filters: {
      title: "Filtres",
      description: "Ajustez la période, le compte, la catégorie et la devise.",
      panelDescription:
        "Ajustez la période et les données que vous voulez analyser.",
  ...
  settings: {
    title: "Paramètres",
    description:
      "Configurez votre expérience, vos données, votre confidentialité et votre forfait.",
    ...
    privacyDescription:
      "Vérifiez comment vos données sont traitées dans Orvian.",
    privacyPolicy: "Politique de confidentialité",
    openPrivacyPolicy: "Voir la politique de confidentialité",

    exportData: "Exporter les données",
    exportDescription:
      "Générez des fichiers avec vos comptes, opérations et virements.",
    exporting: "Exportation...",
    ...
    localDataDescription:
      "Vos données sont enregistrées sur cet appareil. La synchronisation du compte pourra être activée plus tard.",
    viewOnboardingAgain: "Voir l’introduction à nouveau",
    resetData: "Supprimer les données locales",

    about: "À propos d’Orvian",
    aboutDescription:
      "Orvian vous aide à organiser vos comptes, dépenses, budgets et résumés personnels.",
    app: "Application",
    version: "Version",
    ...
    linkErrorDescription:
      "Votre appareil ne peut pas ouvrir ce site web pour le moment.",
    privacyLinkErrorDescription:
      "Votre appareil ne peut pas ouvrir la politique de confidentialité pour le moment.",

    resetDataTitle: "Supprimer les données locales",
    resetDataDescription:
      "Cela supprimera les comptes, opérations, virements, rappels et paramètres enregistrés sur cet appareil.",
  ...
  onboarding: {
    welcome: {
      ...
      description:
        "Enregistrez vos comptes, revenus, dépenses, virements, rappels et plans financiers depuis une application locale et privée.",
    ...
    setup: {
      ...
      description:
        "Ces réponses personnalisent l’application sans vous obliger à créer un compte.",
    },
    ...
    stepOne: {
      ...
      calculateTotalNetWorthDescription:
        "Additionnez banques, espèces, crypto et autres comptes dans un solde général.",
      userType: "Type d’utilisateur",

      personal: "Personnel",
      personalDescription: "Je veux gérer mes finances personnelles.",

      business: "Entreprise",
      businessDescription:
        "Je veux contrôler les revenus et dépenses d’une entreprise.",
    },

    stepTwo: {
      cryptoUsage: "Utilisation des cryptomonnaies",
      noCrypto: "Je n’utilise pas de crypto",
      noCryptoDescription:
        "Je n’ai pas besoin de comptes comme Binance ou MetaMask.",
      useCrypto: "Oui, j’utilise la crypto",
      useCryptoDescription:
        "Je veux enregistrer Binance, MetaMask ou d’autres comptes crypto.",

      multiCurrencyUsage: "Utilisation de plusieurs devises",
      singleCurrency: "Une seule devise",
      singleCurrencyDescription: "J’utilise principalement une seule devise.",
      multipleCurrencies: "Plusieurs devises",
      multipleCurrenciesDescription:
        "J’utilise des comptes dans différentes devises.",
    },

    stepThree: {
      mainGoal: "Objectif principal",

      controlExpenses: "Contrôler les dépenses",
      controlExpensesDescription: "Je veux savoir où va mon argent.",

      saveMoney: "Épargner davantage",
      saveMoneyDescription:
        "Je veux mettre de l’argent de côté pour des objectifs et des réserves.",

      organizeAccounts: "Organiser les comptes",
      organizeAccountsDescription:
        "Je veux voir mes banques, espèces, cartes et dettes de manière ordonnée.",

      activateFinancialReminders: "Activer les rappels financiers",
      activateFinancialRemindersDescription:
        "Cela vous aidera à vous souvenir des paiements, encaissements, achats ou économies.",
    ...
    options: {
      userProfile: {
        ...
        freelancer: {
          label: "Professionnel",
          description:
            "Je gagne de l’argent grâce à des projets ou des clients.",
        },
        entrepreneur: {
          label: "Entrepreneur",
        ...
        investor: {
          label: "Investisseur",
          description:
            "Je veux suivre des actifs, de la crypto ou des investissements.",
        },
        student: {
          label: "Étudiant",
      ...
      cryptoUsage: {
        ...
        basic: {
          ...
          description:
            "Je veux enregistrer des plateformes, des portefeuilles ou des actifs numériques.",
        },
        advanced: {
          label: "J’utilise la crypto, mais ce n’est pas une priorité",
          description:
            "Je veux enregistrer de la crypto, mais ce n’est pas le plus important pour moi.",
        },
      },
      ...
      multiCurrencyUsage: {
        none: {
          ...
          description:
            "Je gère principalement mon argent dans une seule devise.",
        },
        occasional: {
          label: "Parfois",
          description:
            "J’utilise occasionnellement des comptes dans différentes devises.",
        },
        frequent: {
          label: "Fréquemment",
      ...
      financialGoal: {
        ...
        track_income: {
          ...
          description:
            "Je veux avoir un contrôle clair sur mes sources de revenus.",
        },
        understand_investments: {
          label: "Comprendre mes investissements",
          description:
            "Je veux mieux suivre mes actifs, ma crypto ou mes investissements.",
        },
        avoid_small_expenses: {
          label: "Éviter les petites dépenses quotidiennes",
          description:
            "Je veux identifier et contrôler les petites dépenses du quotidien.",
        },
      },
    },
    ...
    plans: {
      ...
      description:
        "Vous pouvez utiliser l’application gratuitement et activer les fonctionnalités avancées plus tard.",
  ...
  budgets: {
    title: "Budgets",
    description:
      "Définissez des limites mensuelles pour contrôler vos dépenses.",

    allCategoriesAlreadyBudgeted:
      "Vous avez déjà ajouté des limites pour toutes les catégories disponibles.",
    budgetedCategories: "Catégories avec limites",
    budgetOf: "Budget pour {{period}}",
    currentSpendingVsBudget:
      "Dépense actuelle comparée à votre limite mensuelle.",
    spent: "Dépensé",
    limit: "Limite",
    ...
    modalDescription:
      "Définissez des limites pour contrôler vos dépenses mensuelles.",
    ...
    categoryBudgetDescription:
      "Ajoutez des limites uniquement aux catégories de dépenses que vous voulez contrôler.",
    ...
    emptyDescription:
      "Créez un budget mensuel pour mieux contrôler vos dépenses.",

    deleteTitle: "Supprimer le budget",
    deleteDescription:
      "Ce budget et ses limites par catégorie seront supprimés.",
    ...
    errors: {
      ...
      categoryLimitGreaterThanZero:
        "La limite mensuelle doit être supérieure à 0.",
  ...
  reminders: {
    title: "Rappels",
    description:
      "Planifiez des paiements, encaissements, achats ou investissements.",
    ...
    emptyDescription:
      "Créez des rappels pour les paiements, encaissements, abonnements, achats ou économies.",
    ...
    types: {
      ...
      subscription: {
        label: "Abonnement",
        description:
          "Netflix, Spotify, logiciels ou autres paiements récurrents.",
      },
      saving: {
        label: "Épargne",
    ...
    deleteTitle: "Supprimer le rappel",
    deleteDescription:
      "Ce rappel n’apparaîtra plus dans vos prochaines alertes.",
  },

  plans: {
    title: "Forfaits",
    description:
      "Choisissez le forfait qui correspond le mieux à votre façon d’organiser vos finances.",
    ...
    demoDescription:
      "Commencez gratuitement et activez les fonctionnalités avancées lorsque vous en avez besoin.",
    ...
    freePlan: {
      name: "Gratuit",
      description:
        "Idéal pour commencer à organiser vos finances personnelles.",
      price: "$0",
    ...
    plusPlan: {
      name: "Plus",
      description:
        "Pour les utilisateurs qui veulent un contrôle financier complet.",
      price: "{{price}}",
      period: "par mois",
      cta: "Activer Plus",
      features: {
