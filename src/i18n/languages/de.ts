export const de = {
  ...
  accounts: {
    title: "Konten",
    description:
      "Erfassen Sie Banken, Bargeld, Kryptowährungen, Karten und Kredite.",
    ...
    emptyDescription:
      "Erstellen Sie Ihr erstes Konto, um Einnahmen, Ausgaben und Überweisungen zu erfassen.",
    ...
    limitDescription:
      "Der kostenlose Plan erlaubt bis zu 3 Konten. Aktivieren Sie Plus, um unbegrenzt Konten zu erstellen.",

    deleteTitle: "Konto löschen",
    deleteDescription:
      "Dieses Konto wird aus der aktiven Liste ausgeblendet. Die bisherigen Transaktionen bleiben erhalten.",
    ...
    form: {
      ...
      balanceEditInfo:
        "Der Saldo wird durch das Erfassen von Transaktionen aktualisiert, nicht durch das Bearbeiten des Kontos.",
      ...
      currencyEditInfo:
        "Die Hauptwährung kann beim Bearbeiten nicht geändert werden, damit der Transaktionsverlauf nicht beschädigt wird.",

      includeInTotal: "Zum geschätzten Gesamtbetrag hinzufügen",
      includeInTotalDescription:
        "Aktivieren Sie dies, wenn dieses Konto zu Ihrem Gesamtsaldo hinzugefügt werden soll.",

      initialBalanceRequired:
        "Der Anfangssaldo ist erforderlich. Verwenden Sie 0, wenn kein Saldo vorhanden ist.",
    ...
    types: {
      ...
      crypto_exchange: {
        ...
        description:
          "Konto in Apps wie Binance oder anderen Krypto-Plattformen.",
      },
      crypto_wallet: {
        label: "Krypto-Wallet",
        description:
          "Wallet wie MetaMask oder andere Apps zum Speichern von Krypto.",
      },
      credit_card: {
        label: "Kreditkarte",
  ...
  movements: {
    title: "Transaktionen",
    description:
      "Erfassen Sie Einnahmen, Ausgaben und Überweisungen zwischen Ihren Konten.",
    ...
    emptyDescription:
      "Erfassen Sie Ihre erste Einnahme, Ausgabe oder Überweisung, um Ihren Finanzverlauf aufzubauen.",
    ...
    freePlanRemaining:
      "Kostenloser Plan: {{count}} Transaktionen in diesem Monat verfügbar.",
    ...
    firstCreateAccountDescription:
      "Sie benötigen mindestens ein aktives Konto, um Einnahmen oder Ausgaben zu erfassen.",

    limitTitle: "Sie haben das Limit für kostenlose Transaktionen erreicht",
    limitDescription:
      "Der kostenlose Plan erlaubt bis zu 30 Transaktionen pro Monat. Aktivieren Sie Plus, um unbegrenzt Transaktionen zu erfassen.",

    deleteMovementTitle: "Transaktion löschen",
    deleteMovementDescription:
      "Diese Aktion setzt den durch diese Transaktion beeinflussten Saldo zurück.",

    deleteTransferTitle: "Überweisung löschen",
    deleteTransferDescription:
      "Diese Aktion setzt die durch diese Überweisung beeinflussten Salden zurück.",
    ...
    negativeBalanceWarning: "Diese Ausgabe wird das Konto ins Minus bringen.",
    ...
    transferCard: {
      ...
      fee: "Gebühr",
      exchangeRate:
        "Verwendeter Wechselkurs: 1 {{fromCurrency}} = {{exchangeRate}} {{toCurrency}}",
    },
    ...
    transferForm: {
      ...
      fromCurrency: "Gesendete Währung",
      toCurrency: "Erhaltene Währung",
      feeAmount: "Kosten oder Gebühr",
      ...
      description:
        "Verschieben Sie Geld zwischen Konten und erfassen Sie Gebühren oder Währungswechsel.",
      ...
      multiCurrencyBlockedByPlan:
        "Der kostenlose Plan erlaubt nur Überweisungen zwischen Konten mit derselben Währung.",

      negativeBalanceWarning:
        "Diese Überweisung wird das Quellkonto ins Minus bringen.",
      ...
      multiCurrencyPlusTitle:
        "Überweisungen zwischen Währungen sind in Plus verfügbar",
      multiCurrencyPlusDescription:
        "Im kostenlosen Plan können Sie zwischen Konten mit derselben Währung überweisen. Für Überweisungen mit Währungswechsel aktivieren Sie Plus.",
    },
  },
  ...
  statistics: {
    title: "Statistiken",
    description:
      "Überprüfen Sie Ihre Einnahmen, Ausgaben, Überweisungen und Kategorien.",
    ...
    charts: {
      ...
      incomeVsExpenseDescription:
        "Monatlicher Vergleich von eingehendem und ausgehendem Geld.",
      ...
      topExpenseCategoriesDescription:
        "Kategorien mit dem höchsten Geldabfluss.",
    ...
    empty: {
      ...
      noIncomeExpenseChart:
        "Es gibt keine Einnahmen- oder Ausgabendaten für das Diagramm.",
      noBalanceTrend:
        "Es gibt noch nicht genügend Saldodaten, um einen Trend anzuzeigen.",
      noExpenseCategoriesChart:
        "Es gibt keine Ausgaben nach Kategorie für das Diagramm.",
      noFilterDataTitle: "Keine Daten für diese Filter",
      noFilterDataDescription:
        "Ändern Sie den Zeitraum oder erfassen Sie Transaktionen, um Statistiken zu sehen.",
  ...
  reports: {
    export: {
      ...
      description:
        "Laden Sie Ihre Konten, Einnahmen, Ausgaben und Überweisungen in einer Datei herunter.",
    },

    filters: {
      title: "Filter",
      description: "Passen Sie Zeitraum, Konto, Kategorie und Währung an.",
      panelDescription:
        "Passen Sie den Zeitraum und die Daten an, die Sie analysieren möchten.",
  ...
  settings: {
    title: "Einstellungen",
    description:
      "Konfigurieren Sie Ihre Erfahrung, Daten, Privatsphäre und Ihren Plan.",
    ...
    privacyDescription:
      "Überprüfen Sie, wie Ihre Daten in Orvian verarbeitet werden.",
    privacyPolicy: "Datenschutzerklärung",
    openPrivacyPolicy: "Datenschutzerklärung anzeigen",

    exportData: "Daten exportieren",
    exportDescription:
      "Erstellen Sie Dateien mit Ihren Konten, Transaktionen und Überweisungen.",
    exporting: "Wird exportiert...",
    ...
    localDataDescription:
      "Ihre Daten werden auf diesem Gerät gespeichert. Kontosynchronisierung kann später aktiviert werden.",
    viewOnboardingAgain: "Einführung erneut anzeigen",
    resetData: "Lokale Daten löschen",

    about: "Über Orvian",
    aboutDescription:
      "Orvian hilft Ihnen, Konten, Ausgaben, Budgets und persönliche Übersichten zu organisieren.",
    app: "Anwendung",
    version: "Version",
    ...
    privacyLinkErrorDescription:
      "Ihr Gerät kann die Datenschutzerklärung derzeit nicht öffnen.",

    resetDataTitle: "Lokale Daten löschen",
    resetDataDescription:
      "Dadurch werden Konten, Transaktionen, Überweisungen, Erinnerungen und Einstellungen gelöscht, die auf diesem Gerät gespeichert sind.",
    ...
    exportExcelErrorDescription:
      "Beim Erstellen der Excel-Datei ist ein Fehler aufgetreten.",
  },
  ...
  onboarding: {
    welcome: {
      ...
      description:
        "Erfassen Sie Konten, Einnahmen, Ausgaben, Überweisungen, Erinnerungen und Finanzpläne in einer lokalen und privaten App.",
    ...
    setup: {
      ...
      description:
        "Diese Antworten personalisieren die App, ohne dass Sie ein Konto erstellen müssen.",
    },
    ...
    stepOne: {
      ...
      calculateTotalNetWorthDescription:
        "Fassen Sie Banken, Bargeld, Krypto und andere Konten in einem Gesamtsaldo zusammen.",
      userType: "Benutzertyp",

      personal: "Privat",
      personalDescription: "Ich möchte meine persönlichen Finanzen verwalten.",

      business: "Geschäft",
      businessDescription:
        "Ich möchte Einnahmen und Ausgaben eines Geschäfts kontrollieren.",
    },

    stepTwo: {
      cryptoUsage: "Nutzung von Kryptowährungen",
      noCrypto: "Ich nutze keine Krypto",
      noCryptoDescription:
        "Ich brauche keine Konten wie Binance oder MetaMask.",
      useCrypto: "Ja, ich nutze Krypto",
      useCryptoDescription:
        "Ich möchte Binance, MetaMask oder andere Krypto-Konten erfassen.",

      multiCurrencyUsage: "Nutzung mehrerer Währungen",
      singleCurrency: "Nur eine Währung",
      singleCurrencyDescription: "Ich nutze hauptsächlich eine Währung.",
      multipleCurrencies: "Mehrere Währungen",
      multipleCurrenciesDescription:
        "Ich nutze Konten in verschiedenen Währungen.",
    },

    stepThree: {
      mainGoal: "Hauptziel",

      controlExpenses: "Ausgaben kontrollieren",
      controlExpensesDescription: "Ich möchte wissen, wohin mein Geld geht.",

      saveMoney: "Mehr sparen",
      saveMoneyDescription:
        "Ich möchte Geld für Ziele und Rücklagen beiseitelegen.",

      organizeAccounts: "Konten organisieren",
      organizeAccountsDescription:
        "Ich möchte Banken, Bargeld, Karten und Schulden geordnet sehen.",

      activateFinancialReminders: "Finanzielle Erinnerungen aktivieren",
      activateFinancialRemindersDescription:
        "Dies hilft Ihnen, Zahlungen, Zahlungseingänge, Käufe oder Ersparnisse nicht zu vergessen.",
    ...
    options: {
      userProfile: {
        ...
        investor: {
          label: "Investor",
          description:
            "Ich möchte Vermögenswerte, Krypto oder Investitionen verfolgen.",
        },
        student: {
          label: "Student",
      ...
      cryptoUsage: {
        ...
        basic: {
          ...
          description:
            "Ich möchte Börsen, Wallets oder digitale Vermögenswerte erfassen.",
        },
        advanced: {
          label: "Ich nutze Krypto, aber es ist keine Priorität",
          description:
            "Ich möchte Krypto erfassen, aber es ist nicht das Wichtigste für mich.",
        },
      },
      ...
      multiCurrencyUsage: {
        ...
        occasional: {
          label: "Manchmal",
          description:
            "Ich nutze gelegentlich Konten in verschiedenen Währungen.",
        },
        frequent: {
          label: "Häufig",
      ...
      financialGoal: {
        ...
        pay_debts: {
          ...
          description:
            "Ich möchte meine Schulden und ausstehenden Zahlungen organisieren.",
        },
        track_income: {
        ...
        understand_investments: {
          ...
          description:
            "Ich möchte meine Vermögenswerte, Krypto oder Investitionen besser verfolgen.",
        },
        avoid_small_expenses: {
          label: "Kleine tägliche Ausgaben vermeiden",
          description:
            "Ich möchte kleine tägliche Ausgaben erkennen und kontrollieren.",
        },
      },
    },
    ...
    plans: {
      ...
      description:
        "Sie können die App kostenlos nutzen und erweiterte Funktionen später aktivieren.",
  ...
  budgets: {
    title: "Budgets",
    description:
      "Legen Sie monatliche Limits fest, um Ihre Ausgaben zu kontrollieren.",

    allCategoriesAlreadyBudgeted:
      "Sie haben bereits Limits für alle verfügbaren Kategorien hinzugefügt.",
    budgetedCategories: "Kategorien mit Limits",
    budgetOf: "Budget für {{period}}",
    currentSpendingVsBudget:
      "Aktuelle Ausgaben im Vergleich zu Ihrem Monatslimit.",
    spent: "Ausgegeben",
    limit: "Limit",
    ...
    modalDescription:
      "Legen Sie Limits fest, um Ihre monatlichen Ausgaben zu kontrollieren.",
    ...
    categoryBudgetDescription:
      "Fügen Sie Limits nur zu den Ausgabenkategorien hinzu, die Sie kontrollieren möchten.",
    ...
    emptyDescription:
      "Erstellen Sie ein Monatsbudget, um Ihre Ausgaben besser zu kontrollieren.",

    deleteTitle: "Budget löschen",
    deleteDescription:
      "Dieses Budget und seine Kategorielimits werden gelöscht.",
    ...
    errors: {
      ...
      duplicatedCategory:
        "Diese Kategorie hat bereits ein zugewiesenes Budget.",
    },
  },
  ...
  reminders: {
    title: "Erinnerungen",
    description:
      "Planen Sie Zahlungen, Zahlungseingänge, Käufe oder Investitionen.",
    ...
    completeDescription:
      "Möchten Sie diese Erinnerung als abgeschlossen markieren?",
    ...
    emptyDescription:
      "Erstellen Sie Erinnerungen für Zahlungen, Zahlungseingänge, Abonnements, Käufe oder Ersparnisse.",
    ...
    form: {
      ...
      timeRequired: "Die Uhrzeit ist erforderlich.",
      accountRequired: "Wählen Sie ein Konto aus.",
    ...
    types: {
      payment: {
        label: "Zahlung",
        description:
          "Dienstleistungen, Schulden, Karte oder Zahlungsverpflichtungen.",
      },
      collection: {
      ...
      subscription: {
        label: "Abonnement",
        description:
          "Netflix, Spotify, Software oder andere wiederkehrende Zahlungen.",
      },
      saving: {
        label: "Sparen",
    ...
    deleteDescription:
      "Diese Erinnerung wird nicht mehr in Ihren anstehenden Benachrichtigungen angezeigt.",
  },

  plans: {
    title: "Pläne",
    description:
      "Wählen Sie den Plan, der am besten dazu passt, wie Sie Ihre Finanzen organisieren.",
    ...
    demoDescription:
      "Starten Sie kostenlos und aktivieren Sie erweiterte Funktionen, wenn Sie sie benötigen.",
    ...
    freePlan: {
      name: "Kostenlos",
      description:
        "Ideal, um mit der Organisation Ihrer persönlichen Finanzen zu beginnen.",
      price: "$0",
      period: "Für immer",
    ...
    errors: {
      ...
      restoreUnavailable:
        "Der Kauf konnte derzeit nicht wiederhergestellt werden.",
    },
  },
