export const ru = {
  ...
  onboarding: {
    ...
    v2: {
      control: {
        title: "Контролируйте деньги без лишней сложности",
        description: "Организуйте счета, балансы и операции в одном месте."
      },
      movements: {
      ...
      start: "Начать сейчас",
      welcome: {
        title: "Добро пожаловать в Orvian",
        description: "Более понятный и простой способ управлять деньгами, счетами и будущими обязательствами."
      },
      accounts: {
        title: "Ваши счета лучше организованы",
        description: "Создавайте счета, отслеживайте балансы и настраивайте карты для наглядного контроля денег."
      },
      analytics: {
        title: "Понимайте финансы с первого взгляда",
        description: "Смотрите тренды, расходы и доходы в простых графиках для лучших решений."
      },
      plans: {
        title: "Начните бесплатно, улучшайте при необходимости",
        description: "Используйте Orvian бесплатно или откройте Plus Lifetime с локальными премиум-функциями."
      },
      continueWithPlus: "Продолжить с Plus",
      continueFree: "Продолжить бесплатно",
      security: {
        title: "Ваши данные защищены",
        description: "Orvian хранит вашу финансовую информацию в безопасном зашифрованном хранилище на вашем устройстве, чтобы вы сохраняли контроль над своими данными."
      }
    }
  },
  budgets: {
  ...
  plans: {
    ...
    v2: {
      ...
      legacy: {
        ...
        shortBenefit: "Специальная скидка за тестирование Orvian до запуска."
      },
      pro: {
      ...
      freePrice: "$0 · Для начала",
      plusPrice: "$4.99 · Разовый платеж",
      legacyPrice: "$2.99 · Цена для ранних пользователей"
    },
    products: {
      plusLifetime: {
  ...
  guides: {
    homeOverview: {
      title: "Ваш финансовый обзор начинается здесь",
      description: "Проверяйте общий баланс, основные счета и последние операции на этом экране."
    },
    movementQuickAdd: {
      title: "Записывайте деньги кнопкой +",
      description: "Используйте центральную кнопку нижнего меню, чтобы быстро создавать расходы, доходы или переводы."
    },
    homeTour: {
      totalBalance: "Здесь вы видите примерный общий баланс ваших счетов.",
      accounts: "Это ваши основные счета. Нажмите на один, чтобы увидеть детали.",
      monthlySummary: "Здесь вы видите сводку доходов, расходов и баланса за месяц.",
      recentActivity: "Здесь отображаются ваши последние операции и переводы."
    },
    statisticsTour: {
      filters: "Используйте эту кнопку, чтобы фильтровать статистику по дате, счету, категории, валюте или типу операции.",
      summary: "Здесь показана сводка периода: доходы, расходы, переводы, комиссии и баланс.",
      incomeVsExpense: "Этот график сравнивает доходы и расходы по месяцам, чтобы понять, тратите ли вы больше, чем получаете.",
      balanceEvolution: "Здесь видно, как меняется ваш баланс со временем и улучшается ли финансовая тенденция.",
      topCategories: "Этот график показывает крупнейшие категории расходов, чтобы понять, куда уходят деньги.",
      budgetUsed: "Если у вас есть активный бюджет, здесь видно, сколько уже использовано и близки ли вы к лимиту.",
