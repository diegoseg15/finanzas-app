export const vi = {
  ...
  accounts: {
    ...
    emptyDescription:
      "Tạo tài khoản đầu tiên để bắt đầu ghi lại thu nhập, chi tiêu và chuyển khoản.",
    ...
    limitDescription:
      "Gói miễn phí cho phép tối đa 3 tài khoản. Kích hoạt Plus để tạo tài khoản không giới hạn.",

    deleteTitle: "Xóa tài khoản",
    deleteDescription:
      "Tài khoản này sẽ được ẩn khỏi danh sách đang hoạt động. Lịch sử giao dịch sẽ được giữ lại.",
    ...
    form: {
      ...
      balanceEditInfo:
        "Số dư được cập nhật bằng cách đăng ký giao dịch, không phải bằng cách chỉnh sửa tài khoản.",
      ...
      currencyEditInfo:
        "Không thể thay đổi tiền tệ chính khi chỉnh sửa để tránh làm sai lịch sử giao dịch.",

      includeInTotal: "Thêm vào tổng ước tính",
      includeInTotalDescription:
        "Bật tùy chọn này nếu bạn muốn tài khoản này được cộng vào tổng số dư của bạn.",

      initialBalanceRequired:
        "Số dư ban đầu là bắt buộc. Nhập 0 nếu tài khoản không có số dư.",
    ...
    types: {
      ...
      piggy_bank: {
        label: "Ống tiết kiệm",
        description:
          "Tiền tiết kiệm vật lý hoặc được tách riêng cho một mục tiêu.",
      },
      crypto_exchange: {
        label: "Nền tảng tiền mã hóa",
        description:
          "Tài khoản trong các ứng dụng như Binance hoặc nền tảng tiền mã hóa khác.",
      },
      crypto_wallet: {
        label: "Ví tiền mã hóa",
        description:
          "Ví như MetaMask hoặc các ứng dụng khác để lưu trữ tiền mã hóa.",
      },
      credit_card: {
        label: "Thẻ tín dụng",
  ...
  movements: {
    title: "Giao dịch",
    description:
      "Đăng ký thu nhập, chi tiêu và chuyển khoản giữa các tài khoản của bạn.",
    ...
    emptyDescription:
      "Đăng ký thu nhập, chi tiêu hoặc chuyển khoản đầu tiên để bắt đầu tạo lịch sử tài chính của bạn.",
    ...
    firstCreateAccountDescription:
      "Bạn cần ít nhất một tài khoản đang hoạt động để đăng ký thu nhập hoặc chi tiêu.",

    limitTitle: "Bạn đã đạt giới hạn giao dịch miễn phí",
    limitDescription:
      "Gói miễn phí cho phép tối đa 30 giao dịch mỗi tháng. Kích hoạt Plus để đăng ký giao dịch không giới hạn.",

    deleteMovementTitle: "Xóa giao dịch",
    deleteMovementDescription:
      "Hành động này sẽ hoàn lại số dư đã bị ảnh hưởng bởi giao dịch này.",

    deleteTransferTitle: "Xóa chuyển khoản",
    deleteTransferDescription:
      "Hành động này sẽ hoàn lại các số dư đã bị ảnh hưởng bởi chuyển khoản này.",
    ...
    negativeBalanceWarning: "Khoản chi này sẽ làm tài khoản có số dư âm.",
    ...
    form: {
      ...
      createDescription:
        "Đăng ký một khoản thu nhập hoặc chi tiêu đã xác nhận.",
    ...
    transferCard: {
      ...
      fee: "Phí",
      exchangeRate:
        "Tỷ giá đã dùng: 1 {{fromCurrency}} = {{exchangeRate}} {{toCurrency}}",
    },
    ...
    transferForm: {
      ...
      fromCurrency: "Tiền tệ gửi",
      toCurrency: "Tiền tệ nhận",
      feeAmount: "Chi phí hoặc phí",
      feeCurrency: "Tiền tệ của phí",
      exchangeRate: "Tỷ giá",
      note: "Ghi chú",
      ...
      description:
        "Chuyển tiền giữa các tài khoản và đăng ký phí hoặc quy đổi tiền tệ.",
      ...
      multiCurrencyBlockedByPlan:
        "Gói miễn phí chỉ cho phép chuyển khoản giữa các tài khoản cùng loại tiền tệ.",

      negativeBalanceWarning:
        "Chuyển khoản này sẽ làm tài khoản nguồn có số dư âm.",
      ...
      multiCurrencyPlusTitle:
        "Chuyển khoản giữa các loại tiền tệ có trong Plus",
      multiCurrencyPlusDescription:
        "Trong gói miễn phí, bạn có thể chuyển khoản giữa các tài khoản cùng loại tiền tệ. Để chuyển khoản có quy đổi tiền tệ, hãy kích hoạt Plus.",
    },
  },
  ...
  statistics: {
    title: "Thống kê",
    description:
      "Xem lại thu nhập, chi tiêu, chuyển khoản và danh mục của bạn.",
    ...
    charts: {
      ...
      incomeVsExpenseDescription:
        "So sánh hằng tháng giữa tiền vào và tiền ra.",
      ...
      topExpenseCategoriesDescription:
        "Các danh mục có lượng tiền chi ra nhiều nhất.",
  ...
  reports: {
    export: {
      title: "Xuất tóm tắt",
      description:
        "Tải xuống tài khoản, thu nhập, chi tiêu và chuyển khoản của bạn trong một tệp.",
    },

    filters: {
      title: "Bộ lọc",
      description: "Điều chỉnh kỳ hạn, tài khoản, danh mục và tiền tệ.",
  ...
  settings: {
    title: "Cài đặt",
    description:
      "Cấu hình trải nghiệm, dữ liệu, quyền riêng tư và gói của bạn.",
    ...
    privacyDescription:
      "Kiểm tra cách dữ liệu của bạn được xử lý trong Orvian.",
    privacyPolicy: "Chính sách quyền riêng tư",
    openPrivacyPolicy: "Xem chính sách quyền riêng tư",

    exportData: "Xuất dữ liệu",
    exportDescription:
      "Tạo tệp với tài khoản, giao dịch và chuyển khoản của bạn.",
    exporting: "Đang xuất...",
    exportCsv: "Xuất CSV",
    ...
    localDataDescription:
      "Dữ liệu của bạn được lưu trên thiết bị này. Đồng bộ tài khoản có thể được bật sau.",
    viewOnboardingAgain: "Xem phần giới thiệu lại",
    resetData: "Xóa dữ liệu cục bộ",

    about: "Giới thiệu về Orvian",
    aboutDescription:
      "Orvian giúp bạn sắp xếp tài khoản, chi tiêu, ngân sách và báo cáo cá nhân.",
    app: "Ứng dụng",
    version: "Phiên bản",
    ...
    privacyLinkErrorDescription:
      "Thiết bị của bạn hiện không thể mở chính sách quyền riêng tư.",

    resetDataTitle: "Xóa dữ liệu cục bộ",
    resetDataDescription:
      "Thao tác này sẽ xóa tài khoản, giao dịch, chuyển khoản, nhắc nhở và cài đặt đã lưu trên thiết bị này.",
  ...
  onboarding: {
    welcome: {
      ...
      description:
        "Đăng ký tài khoản, thu nhập, chi tiêu, chuyển khoản, nhắc nhở và kế hoạch tài chính từ một ứng dụng cục bộ và riêng tư.",
    ...
    setup: {
      ...
      description:
        "Những câu trả lời này giúp cá nhân hóa ứng dụng mà không bắt buộc bạn tạo tài khoản.",
    },
    ...
    stepOne: {
      ...
      calculateTotalNetWorthDescription:
        "Cộng ngân hàng, tiền mặt, tiền mã hóa và các tài khoản khác vào một số dư tổng thể.",
      userType: "Loại người dùng",

      personal: "Cá nhân",
      personalDescription: "Tôi muốn quản lý tài chính cá nhân.",

      business: "Kinh doanh",
      businessDescription:
        "Tôi muốn kiểm soát thu nhập và chi tiêu cho một doanh nghiệp.",
    },

    stepTwo: {
      cryptoUsage: "Sử dụng tiền mã hóa",
      noCrypto: "Tôi không dùng tiền mã hóa",
      noCryptoDescription: "Tôi không cần tài khoản như Binance hoặc MetaMask.",
      useCrypto: "Có, tôi dùng tiền mã hóa",
      useCryptoDescription:
        "Tôi muốn đăng ký Binance, MetaMask hoặc các tài khoản tiền mã hóa khác.",

      multiCurrencyUsage: "Sử dụng nhiều loại tiền tệ",
      singleCurrency: "Chỉ một loại tiền tệ",
      singleCurrencyDescription: "Tôi chủ yếu dùng một loại tiền tệ.",
      multipleCurrencies: "Nhiều loại tiền tệ",
      multipleCurrenciesDescription:
        "Tôi dùng tài khoản bằng các loại tiền tệ khác nhau.",
    },

    stepThree: {
      mainGoal: "Mục tiêu chính",

      controlExpenses: "Kiểm soát chi tiêu",
      controlExpensesDescription: "Tôi muốn biết tiền của mình đi đâu.",

      saveMoney: "Tiết kiệm nhiều hơn",
      saveMoneyDescription:
        "Tôi muốn để riêng tiền cho mục tiêu và quỹ dự phòng.",

      organizeAccounts: "Sắp xếp tài khoản",
      organizeAccountsDescription:
        "Tôi muốn xem ngân hàng, tiền mặt, thẻ và nợ một cách có trật tự.",

      activateFinancialReminders: "Bật nhắc nhở tài chính",
      activateFinancialRemindersDescription:
        "Điều này sẽ giúp bạn nhớ các khoản thanh toán, khoản cần thu, mua sắm hoặc tiết kiệm.",
    ...
    options: {
      userProfile: {
        ...
        entrepreneur: {
          label: "Doanh nhân",
          description:
            "Tôi quản lý tiền cho một doanh nghiệp hoặc dự án kinh doanh.",
        },
        investor: {
          label: "Nhà đầu tư",
          description:
            "Tôi muốn theo dõi tài sản, tiền mã hóa hoặc khoản đầu tư.",
        },
        student: {
          label: "Sinh viên",
      ...
      cryptoUsage: {
        ...
        basic: {
          ...
          description:
            "Tôi muốn đăng ký sàn giao dịch, ví hoặc tài sản kỹ thuật số.",
        },
        advanced: {
          label: "Tôi dùng tiền mã hóa, nhưng không phải ưu tiên",
          description:
            "Tôi muốn đăng ký tiền mã hóa, nhưng đó không phải điều quan trọng nhất với tôi.",
        },
      },
      ...
      multiCurrencyUsage: {
        ...
        occasional: {
          label: "Thỉnh thoảng",
          description:
            "Tôi thỉnh thoảng dùng tài khoản bằng các loại tiền tệ khác nhau.",
        },
        frequent: {
          label: "Thường xuyên",
          description:
            "Tôi thường xuyên dùng tài khoản bằng nhiều loại tiền tệ.",
        },
      },
      ...
      financialGoal: {
        ...
        pay_debts: {
          label: "Trả nợ",
          description:
            "Tôi muốn sắp xếp các khoản nợ và khoản thanh toán còn pending.",
        },
        track_income: {
        ...
        understand_investments: {
          ...
          description:
            "Tôi muốn theo dõi tốt hơn tài sản, tiền mã hóa hoặc khoản đầu tư của mình.",
        },
        avoid_small_expenses: {
          label: "Tránh chi tiêu nhỏ hằng ngày",
          description:
            "Tôi muốn nhận diện và kiểm soát các khoản chi nhỏ mỗi ngày.",
        },
      },
    },
    ...
    plans: {
      ...
      description:
        "Bạn có thể dùng ứng dụng miễn phí và kích hoạt các tính năng nâng cao sau.",
  ...
  budgets: {
    ...
    allCategoriesAlreadyBudgeted:
      "Bạn đã thêm giới hạn cho tất cả các danh mục có sẵn.",
    budgetedCategories: "Danh mục có giới hạn",
    budgetOf: "Ngân sách cho {{period}}",
    currentSpendingVsBudget:
      "Chi tiêu hiện tại so với giới hạn hằng tháng của bạn.",
    spent: "Đã chi",
    limit: "Giới hạn",
    ...
    categoryBudgetDescription:
      "Chỉ thêm giới hạn cho các danh mục chi tiêu bạn muốn kiểm soát.",
    ...
    deleteDescription:
      "Ngân sách này và các giới hạn danh mục của nó sẽ bị xóa.",
  ...
  reminders: {
    ...
    completeDescription:
      "Bạn có muốn đánh dấu nhắc nhở này là đã hoàn tất không?",
    ...
    emptyDescription:
      "Tạo nhắc nhở cho thanh toán, khoản cần thu, đăng ký, mua sắm hoặc tiết kiệm.",
    ...
    types: {
      ...
      subscription: {
        label: "Đăng ký",
        description:
          "Netflix, Spotify, phần mềm hoặc các khoản thanh toán định kỳ khác.",
      },
      saving: {
        label: "Tiết kiệm",
    ...
    deleteDescription:
      "Nhắc nhở này sẽ không còn xuất hiện trong các cảnh báo sắp tới của bạn.",
  },
  ...
  plans: {
    ...
    demoDescription:
      "Bắt đầu miễn phí và kích hoạt các tính năng nâng cao khi bạn cần.",
