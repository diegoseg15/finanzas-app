export const it = {
  ...
  accounts: {
    ...
    emptyDescription:
      "Crea il tuo primo conto per iniziare a registrare entrate, spese e trasferimenti.",
    ...
    limitDescription:
      "Il piano gratuito consente fino a 3 conti. Attiva Plus per creare conti illimitati.",

    deleteTitle: "Elimina conto",
    deleteDescription:
      "Questo conto verrà nascosto dalla lista attiva. I suoi movimenti storici saranno conservati.",
    ...
    form: {
      ...
      balanceEditInfo:
        "Il saldo viene aggiornato registrando movimenti, non modificando il conto.",
      ...
      currencyEditInfo:
        "La valuta principale non può essere modificata durante l’editing, per evitare problemi nello storico dei movimenti.",

      includeInTotal: "Aggiungi al totale stimato",
      includeInTotalDescription:
        "Attiva questa opzione se vuoi che questo conto venga sommato al tuo saldo totale.",

      initialBalanceRequired:
        "Il saldo iniziale è obbligatorio. Usa 0 se non ha saldo.",
    ...
    types: {
      ...
      crypto_wallet: {
        ...
        description:
          "Wallet come MetaMask o altre app per conservare criptovalute.",
      },
      credit_card: {
  ...
  movements: {
    ...
    emptyDescription:
      "Registra la tua prima entrata, spesa o trasferimento per iniziare a costruire il tuo storico finanziario.",
    ...
    freePlanRemaining:
      "Piano gratuito: {{count}} movimenti disponibili questo mese.",
    ...
    firstCreateAccountDescription:
      "Hai bisogno di almeno un conto attivo per registrare entrate o spese.",

    limitTitle: "Hai raggiunto il limite di movimenti gratuiti",
    limitDescription:
      "Il piano gratuito consente fino a 30 movimenti al mese. Attiva Plus per registrare movimenti illimitati.",

    deleteMovementTitle: "Elimina movimento",
    deleteMovementDescription:
      "Questa azione annullerà l’effetto di questo movimento sul saldo.",

    deleteTransferTitle: "Elimina trasferimento",
    deleteTransferDescription:
      "Questa azione annullerà l’effetto di questo trasferimento sui saldi.",
    ...
    negativeBalanceWarning: "Questa spesa lascerà il conto con saldo negativo.",
    ...
    transferCard: {
      ...
      fee: "Commissione",
      exchangeRate:
        "Cambio usato: 1 {{fromCurrency}} = {{exchangeRate}} {{toCurrency}}",
    },
    ...
    transferForm: {
      ...
      fromCurrency: "Valuta inviata",
      toCurrency: "Valuta ricevuta",
      feeAmount: "Costo o commissione",
      ...
      description:
        "Sposta denaro tra conti e registra commissioni o cambio valuta.",
      ...
      multiCurrencyBlockedByPlan:
        "Il piano gratuito consente solo trasferimenti tra conti con la stessa valuta.",

      negativeBalanceWarning:
        "Questo trasferimento lascerà il conto di origine con saldo negativo.",
      ...
      multiCurrencyPlusTitle:
        "I trasferimenti tra valute sono disponibili in Plus",
      multiCurrencyPlusDescription:
        "Nel piano gratuito puoi trasferire tra conti con la stessa valuta. Per trasferimenti con cambio valuta, attiva Plus.",
    },
  },
  ...
  statistics: {
    ...
    charts: {
      ...
      incomeVsExpenseDescription:
        "Confronto mensile tra denaro in entrata e in uscita.",
      ...
      topExpenseCategoriesDescription:
        "Categorie con la maggiore uscita di denaro.",
    ...
    empty: {
      ...
      noIncomeExpenseChart:
        "Non ci sono dati di entrate o spese da visualizzare nel grafico.",
      noBalanceTrend:
        "Non ci sono ancora dati sufficienti sul saldo per mostrare una tendenza.",
      noExpenseCategoriesChart:
        "Non ci sono spese per categoria da visualizzare nel grafico.",
      noFilterDataTitle: "Nessun dato per questi filtri",
      noFilterDataDescription:
        "Cambia il periodo o registra movimenti per vedere le statistiche.",
  ...
  reports: {
    export: {
      ...
      description:
        "Scarica i tuoi conti, entrate, spese e trasferimenti in un file.",
    },

    filters: {
      title: "Filtri",
      description: "Regola periodo, conto, categoria e valuta.",
  ...
  settings: {
    ...
    exportDescription:
      "Genera file con i tuoi conti, movimenti e trasferimenti.",
    exporting: "Esportazione...",
    ...
    localDataDescription:
      "I tuoi dati vengono salvati su questo dispositivo. La sincronizzazione dell’account potrà essere attivata in seguito.",
    viewOnboardingAgain: "Vedi di nuovo l’introduzione",
    resetData: "Elimina dati locali",

    about: "Informazioni su Orvian",
    aboutDescription:
      "Orvian ti aiuta a organizzare conti, spese, budget e riepiloghi personali.",
    app: "Applicazione",
    version: "Versione",
    ...
    linkErrorDescription:
      "Il tuo dispositivo non può aprire questo sito in questo momento.",
    privacyLinkErrorDescription:
      "Il tuo dispositivo non può aprire l’informativa sulla privacy in questo momento.",

    resetDataTitle: "Elimina dati locali",
    resetDataDescription:
      "Questo eliminerà conti, movimenti, trasferimenti, promemoria e impostazioni salvati su questo dispositivo.",
    resetDataConfirm: "Elimina",

    exportErrorTitle: "Impossibile esportare",
    exportCsvErrorDescription:
      "Si è verificato un errore durante la generazione del file CSV.",
    exportExcelErrorDescription:
      "Si è verificato un errore durante la generazione del file Excel.",
  },
  ...
  onboarding: {
    welcome: {
      ...
      description:
        "Registra conti, entrate, spese, trasferimenti, promemoria e piani finanziari da un’app locale e privata.",
    ...
    setup: {
      ...
      description:
        "Queste risposte personalizzano l’app senza obbligarti a creare un account.",
    },
    ...
    stepOne: {
      ...
      calculateTotalNetWorthDescription:
        "Somma banche, contanti, crypto e altri conti in un saldo generale.",
      userType: "Tipo di utente",

      personal: "Personale",
      personalDescription: "Voglio gestire le mie finanze personali.",

      business: "Attività",
      businessDescription: "Voglio controllare entrate e spese di un’attività.",
    },

    stepTwo: {
      cryptoUsage: "Uso di criptovalute",
      noCrypto: "Non uso crypto",
      noCryptoDescription: "Non ho bisogno di conti come Binance o MetaMask.",
      useCrypto: "Sì, uso crypto",
      useCryptoDescription:
        "Voglio registrare Binance, MetaMask o altri conti crypto.",

      multiCurrencyUsage: "Uso di più valute",
      singleCurrency: "Una sola valuta",
      singleCurrencyDescription: "Uso principalmente una sola valuta.",
      multipleCurrencies: "Più valute",
      multipleCurrenciesDescription: "Uso conti in valute diverse.",
    },

    stepThree: {
      mainGoal: "Obiettivo principale",

      controlExpenses: "Controllare le spese",
      controlExpensesDescription: "Voglio sapere dove va il mio denaro.",

      saveMoney: "Risparmiare di più",
      saveMoneyDescription:
        "Voglio mettere da parte denaro per obiettivi e riserve.",

      organizeAccounts: "Organizzare i conti",
      organizeAccountsDescription:
        "Voglio vedere banche, contanti, carte e debiti in ordine.",

      activateFinancialReminders: "Attivare promemoria finanziari",
      activateFinancialRemindersDescription:
        "Questo ti aiuterà a ricordare pagamenti, incassi, acquisti o risparmi.",
    ...
    options: {
      ...
      cryptoUsage: {
        ...
        advanced: {
          ...
          description:
            "Voglio registrare crypto, ma non è la cosa più importante per me.",
        },
      },
      ...
      financialGoal: {
        ...
        pay_debts: {
          label: "Pagare debiti",
          description:
            "Voglio organizzare i miei debiti e pagamenti in sospeso.",
        },
        track_income: {
          label: "Monitorare le mie entrate",
          description:
            "Voglio avere un controllo chiaro delle mie fonti di reddito.",
        },
        ...
        avoid_small_expenses: {
          ...
          description:
            "Voglio identificare e controllare le piccole spese giornaliere.",
        },
      },
    },
    ...
    plans: {
      ...
      description:
        "Puoi usare l’app gratuitamente e attivare le funzioni avanzate in seguito.",
  ...
  budgets: {
    ...
    allCategoriesAlreadyBudgeted:
      "Hai già aggiunto limiti per tutte le categorie disponibili.",
    ...
    categoryBudgetDescription:
      "Aggiungi limiti solo alle categorie di spesa che vuoi controllare.",
    ...
    emptyDescription:
      "Crea un budget mensile per controllare meglio le tue spese.",

    deleteTitle: "Elimina budget",
    deleteDescription:
      "Questo budget e i suoi limiti per categoria saranno eliminati.",
    ...
    errors: {
      ...
      categoryLimitGreaterThanZero:
        "Il limite mensile deve essere maggiore di 0.",
  ...
  reminders: {
    ...
    emptyDescription:
      "Crea promemoria per pagamenti, incassi, abbonamenti, acquisti o risparmi.",
    ...
    deleteTitle: "Elimina promemoria",
    deleteDescription:
      "Questo promemoria non apparirà più nei tuoi avvisi futuri.",
  },

  plans: {
    title: "Piani",
    description:
      "Scegli il piano più adatto al modo in cui organizzi le tue finanze.",
    ...
    demoDescription:
      "Inizia gratuitamente e attiva le funzioni avanzate quando ne hai bisogno.",
