export const ja = {
  ...
  guides: {
    ...
    statisticsTour: {
      filters: "このボタンで日付、口座、カテゴリ、通貨、取引タイプ別に統計を絞り込めます。",
      summary: "ここで期間の概要（収入、支出、送金、手数料、残高）を確認できます。",
      incomeVsExpense: "このグラフは月ごとの収入と支出を比較し、支出が収入を上回っていないか確認できます。",
      balanceEvolution: "ここでは残高が時間とともにどう変化し、財務傾向が改善しているか悪化しているかを確認できます。",
      topCategories: "このグラフは支出が多いカテゴリを表示し、お金がどこに使われているかを把握できます。",
      budgetUsed: "有効な予算がある場合、ここで使用額と上限に近いかどうかを確認できます。",
