export const pt = {
  common: {
    ...
    operationError: "Não foi possível concluir a operação."
  },
  tabs: {
    home: "Início",
    accounts: "Contas",
  ...
  movements: {
    ...
    form: {
      ...
      addAttachment: "Adicionar imagem ou PDF",
      attachmentError: "Não foi possível anexar o arquivo. Use uma imagem ou PDF válido."
    },
    card: {
      defaultTitle: "Movimentação",
      deletedAccount: "Conta excluída",
      attachment: "Comprovante",
      balanceAfterMovement: "Saldo após",
      account: "Conta",
      category: "Categoria",
      date: "Data",
      status: "Estado",
    ...
    calculatorAmount: "Valor do movimento",
    transferAmount: "Valor a transferir",
    emptyFilterTitle: "Sem resultados",
    emptyFilterDescription: "Altere o filtro para ver outros movimentos.",
    newExpense: "Nova despesa",
    newIncome: "Nova receita",
    attachment: {
      openErrorTitle: "Não foi possível abrir",
      openErrorDescription: "Não há um aplicativo disponível para abrir este comprovante."
    },
    status: {
  ...
  settings: {
    ...
    shortcuts: {
      budgets: "Orçamentos",
      budgetsDescription: "Gerenciar limites mensais",
      reminders: "Lembretes",
      remindersDescription: "Pagamentos, recebimentos e assinaturas"
    },
    ...
    importData: {
      ...
      description: "Carregar movimentos de um CSV",
      modalDescription: "Carregue movimentos de um arquivo CSV compatível."
    },
    ...
    mainCurrency: {
      ...
      description: "A moeda principal é usada para totais, relatórios e resumo mensal. Ela não converte saldos existentes automaticamente."
    },
    secureStorage: {
      title: "Armazenamento seguro",
      description: "Seus dados são salvos criptografados neste dispositivo",
      modalDescription: "O Orvian protege seus dados financeiros salvando-os localmente e criptografados no seu dispositivo.",
      encryptedDataTitle: "Dados criptografados",
      encryptedDataDescription: "Suas contas, movimentos, transferências, orçamentos e lembretes são salvos criptografados neste dispositivo.",
      localOnlyTitle: "Armazenamento local",
      localOnlyDescription: "Suas informações financeiras ficam no seu telefone. Você não precisa criar uma conta para usar o Orvian.",
      noCloudTitle: "Sem nuvem própria",
      noCloudDescription: "O Orvian não envia seus dados financeiros para servidores próprios nem os sincroniza automaticamente.",
      exportsTitle: "Exportações sob seu controle",
      exportsDescription: "Arquivos CSV ou Excel só são criados quando você decide exportá-los.",
      backupTitle: "Backup",
      backupDescription: "Se você trocar de telefone ou apagar o app, exporte uma cópia para não perder suas informações."
    },
    sections: {
  ...
  onboarding: {
    ...
    v2: {
      control: {
        title: "Controle seu dinheiro sem complicar",
        description: "Organize contas, saldos e movimentações em um só lugar."
      },
      movements: {
        title: "Registre despesas e receitas em segundos",
        description: "Use um formulário rápido estilo calculadora para registrar seu dinheiro com menos esforço."
      },
      reminders: {
        title: "Não esqueça pagamentos nem cobranças",
        description: "Crie lembretes para pagamentos, cobranças e compromissos recorrentes."
      },
      clarity: {
        title: "Veja suas finanças com clareza",
        description: "Entenda seus saldos, movimentações e próximos compromissos em um app simples."
      },
      currency: {
        title: "Escolha sua moeda principal",
        description: "Usaremos esta moeda para mostrar seus totais, relatórios e saldos principais."
      },
      start: "Começar agora",
      welcome: {
        title: "Bem-vindo ao Orvian",
        description: "Uma forma mais clara e simples de controlar seu dinheiro, contas e próximos compromissos."
      },
      accounts: {
        title: "Suas contas, mais organizadas",
        description: "Crie contas, controle saldos e personalize cartões para ver seu dinheiro com clareza."
      },
      analytics: {
        title: "Entenda suas finanças rapidamente",
        description: "Veja tendências, despesas e receitas com gráficos simples para tomar melhores decisões."
      },
      plans: {
      ...
      security: {
        ...
        description: "O Orvian guarda suas informações financeiras em armazenamento seguro e criptografado no seu dispositivo, para que você mantenha o controle dos seus dados."
      }
    }
  },
  budgets: {
  ...
  plans: {
    ...
    freePlan: {
      ...
      features: {
        ...
        basicMovements: "Registro básico de movimentações",
        baseCategories: "Categorias básicas",
        theme: "Modo claro e escuro"
      }
    },
    plusPlan: {
      name: "Plus",
    ...
    v2: {
      title: "Escolha como crescer com Orvian",
      description: "Comece grátis e desbloqueie recursos premium quando precisar.",
      oneTimePayment: "Pagamento único",
      unlockPlus: "Desbloquear Plus",
      plusActive: "Plus ativo",
      buyPack: "Comprar pacote",
      included: "Incluído",
      includedWithPlus: "Incluído no Plus",
      cardDesigns: {
    ...
    products: {
      plusLifetime: {
        ...
        features: {
          ...
          localExport: "Exportação local de dados"
        }
      },
      cardPacks: {
        dark: {
          description: "Designs escuros e elegantes para suas contas."
        },
        luxury: {
          description: "Designs exclusivos para um app com mais presença."
        },
        crypto: {
          description: "Designs inspirados em ativos digitais e wallets."
        },
        minimal: {
          description: "Designs limpos e minimalistas para contas pessoais."
        }
      }
    },
    purchase: {
      errorTitle: "Não foi possível iniciar a compra",
      errorDescription: "Verifique sua conexão ou tente novamente pelo Google Play."
    }
  },
  categories: {
    salary: "Salário",
  ...
  guides: {
    homeOverview: {
      ...
      description: "Veja seu saldo total, contas principais e movimentações recentes nesta tela."
    },
    movementQuickAdd: {
    ...
    statisticsTour: {
      filters: "Use este botão para filtrar suas estatísticas por data, conta, categoria, moeda ou tipo de movimento.",
      summary: "Aqui você vê um resumo do período: receitas, despesas, transferências, taxas e saldo.",
      incomeVsExpense: "Este gráfico compara receitas e despesas por mês para identificar se você está gastando mais do que entra.",
      balanceEvolution: "Aqui você vê como seu saldo evolui ao longo do tempo e se sua tendência financeira melhora ou piora.",
  ...
  imports: {
    csv: {
      cardTitle: "Importar movimentos",
      cardDescription: "Carregue um CSV com colunas Data, Tipo, Conta, Valor, Moeda, Categoria e Nota.",
      readingFile: "Lendo arquivo...",
      selectCsv: "Selecionar CSV",
      accountRequired: "Crie uma conta primeiro para poder importar movimentos.",
      selectedFile: "Arquivo: {{fileName}}",
      selectedCsvFallback: "CSV selecionado",
      validRows: "Válidos",
      errorRows: "Erros",
      duplicateRows: "Duplicados",
      row: "Linha {{row}}",
      previewLimit: "Mostrando {{shown}} de {{total}} linhas.",
      importValid: "Importar válidos",
      readErrorTitle: "Não foi possível ler o CSV",
      pickErrorDescription: "Ocorreu um erro ao selecionar o arquivo.",
      confirmTitle: "Importar movimentos",
      confirmDescription: "{{count}} movimentos válidos serão importados. Duplicados e erros serão ignorados.",
      importAction: "Importar",
      completedTitle: "Importação concluída",
      completedDescription: "{{count}} movimentos foram importados."
    }
  }
} as const;
